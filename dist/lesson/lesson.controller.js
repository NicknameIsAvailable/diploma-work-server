...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: create_lesson_dto_1.CreateLessonDto, isArray: true }),
    (0, swagger_1.ApiResponse)({
        status: 201,
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Возвращает урок', type: lesson_entity_1.Lesson }),
